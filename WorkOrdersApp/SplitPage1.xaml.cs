...
namespace WorkOrdersApp
{
    ...
    public sealed partial class SplitPage1 : Page
    {
        ...
        public async void updateView()
        {
            ...
            string wListURL = environment + "/services/apexrest/MyRestPullWorkOrderList/" + mclientID;
            //     //+" -H 'Authorization: Bearer " + _token.AccessToken + "'";
            //// string wListURL = environment + "/services/apexrest/MyRestPullWorkOrderList/"+mclientID;
            ...
            WorkOrdrList = JsonConvert.DeserializeObject<List<WorkOrderModel>>(json);
            

            itemListView.ItemsSource = WorkOrdrList;
        ...
        public SplitPage1()
        {
            ...
            this.navigationHelper.GoBackCommand = new WorkOrdersApp.AppCommon.RelayCommand(() => this.GoBack(), () => this.CanGoBack());
